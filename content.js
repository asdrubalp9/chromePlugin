...
const downloadBtnHTML = `
    <button id="downloadBtn" style="position: fixed;top: 1em;right: 1em;border-radius: 50%;height: 50px;width: 50px;display: flex;align-items: center;justify-content: center;" class="btn btn-primary">
